...
(function () {
  ...
  function createHomeSkeleton() {
    ...
    div.innerHTML = `
      ...
      <div class="skeleton-pulse" style="height: 120px; border-radius: 16px;"></div>
      <div class="skeleton-pulse" style="height: 170px; border-radius: 16px;"></div>
      <div class="skeleton-pulse" style="height: 160px; border-radius: 16px;"></div>
      <div class="skeleton-pulse" style="height: 160px; border-radius: 16px;"></div>
    `;
    return div;
  }
...
strong.textContent = pageName; // textContent prevents XSS
const msg = document.createElement('div');
msg.style.cssText = 'font-size: 13px; color: var(--color-text-secondary); margin-bottom: 20px; max-width: 300px;';
msg.appendChild(document.createTextNode('The module '));
msg.appendChild(strong);
msg.appendChild(document.createTextNode(' could not be loaded.'));
